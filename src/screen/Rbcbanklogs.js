                ...
                <tr>
                  <th colspan="4">
                    <span className="bg-danger dangerbg">
                      RBC Bank Logs: 13 Logs available
                    </span>
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1400.55", balance: "$130" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1773.55", balance: "$160" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2090.33", balance: "$180" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "3164.55", balance: "$279" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4070.82", balance: "$330" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4500.35", balance: "$400" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
