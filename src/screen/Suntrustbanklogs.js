...
export default function Suntrustbanklogs() {
                ...
                <tr>
                  <th colspan="4">
                    <span className="bg-danger dangerbg">
                      Sunturt Bank Logs: 13 Logs available
                    </span>
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "1350.33", balance: "$101" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1500.75", balance: "$130" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1753.55", balance: "$160" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2000.77", balance: "$196" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2500.22", balance: "$223" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2900.01", balance: "$255" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3050.56", balance: "$276" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3500.33", balance: "$320" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3800.86", balance: "$340" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4000.35", balance: "$370" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
