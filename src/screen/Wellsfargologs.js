...
export default function Wellsfargologs() {
                ...
                <tr>
                  <th colspan="4">
                    <span className="bg-danger dangerbg">
                      Wells-Fargo Bank Logs: 13 Logs available
                    </span>
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "1150.55", balance: "$110" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1500.15", balance: "$145" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1783.55", balance: "$174" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1900.71", balance: "$200" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2000.22", balance: "$225" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2900.44", balance: "$245" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3023.56", balance: "$260" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3400.95", balance: "$300" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3500.55", balance: "$320" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3900.88", balance: "$345" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4300.44", balance: "$420" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4453.34", balance: "$450" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
