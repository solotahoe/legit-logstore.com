                ...
                <tr>
                  <th colspan="4">
                    <span className="bg-danger dangerbg">
                      HSBC Bank Logs: 13 Logs available
                    </span>
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "1354.64", balance: "$100" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1430.75", balance: "$140" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$1783.55", balance: "$170" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2160.53", balance: "$200" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$2655.02", balance: "$230" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3000.11", balance: "$250" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "3100.55", balance: "$299" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$3800.45", balance: "$330" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4110.85", balance: "$350" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr className="evencols">
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$5600.54", balance: "$400" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
                ...
                <tr>
                  ...
                  <td>
                    <Link
                      to="/addfunds"
                      state={{ from: "$4750.51", balance: "$420" }}
                    >
                      <button className="Purchasebtn">
                        {" "}
                        <i
